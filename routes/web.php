...
//    Route::get('bigblue/api/callback','BigBlueController@logout');
  ...
  Route::middleware(['IsInstalled' ,'switch_languages', 'ip_block'])->group(function () {
    ...
    Route::middleware(['is_verified', 'maintanance_mode'])->group(function () {
        ...
        Route::get('/instructor-list', 'HomeController@instructorList')->name('instructor');
    ...
    Route::middleware(['is_active', 'auth', 'maintanance_mode'])->group(function () {
        ...
        Route::middleware(['is_admin'])->group(function () {
            ...
            Route::post('/quickupdate/sessionBatch/{id}','QuickUpdateController@sessionBatchQuick')->name('sessionBatch.quick');
        ...
        Route::middleware(['admin_instructor', 'IsInstalled'])->group(function () {
            ...
            Route::resource('batch-setting','SessionBatchController');
            ...
            Route::get('reposition/session/batch', 'SessionBatchController@reposition')->name('session_batch_reposition');
