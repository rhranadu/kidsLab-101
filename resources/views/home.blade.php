...
<link rel="stylesheet" type="text/css" href="{{url('wizard/fonts/material-design-iconic-font/css/material-design-iconic-font.min.css')}}">
...
<div class="page-content">
    <div class="wizard-heading">Kidslab101 Courses Wizard</div>
    <div class="wizard-v6-content">
            ...
            <form class="form-register" id="form-register" action="#">
                <div id="form-total">
                    ...
                    <h2>
                        ...
                        <span class="step-text">Class 4 to 5</span>
                    </h2>
                    <section>
                        <div class="inner">
                            ...
                            <!--                            <div class="form-row">-->
                            <!--                            </div>-->
                            @if(count($student_courses_type1) == 1)
                            <div class="row col-lg-12">
                                <div class="col-lg-3">
                                </div>
                                @foreach($student_courses_type1 as $student_course)
                                <div class="col-lg-5 ">
                                    <div class="card bg-primary" style="width: 22rem;">
                                        <div class="card-body">
                                            <h5 class="card-title text-center text-white p-2">
                                                <span class="border border-dark p-2">{{ str_limit($student_course->courses->title, $limit = 30, $end = '...') }}</span>
                                            </h5>
                                            <h6 class="card-title text-center text-white">
                                                <span class="border border-dark p-1">Total class: {{count($student_course->courseClasses)}} ||  Per Class : 1:30 hours</span>
                                            </h6>
                                            <p class="card-text pt-4"><strong>1. Short Details of Course:</strong></p>
                                            <p class="card-text">{{$student_course->courses->short_detail}}</p>
                                            <p class="card-text text-center pt-2">
                                                <a href="{{route('course.content',['id' => $student_course->courses->id, 'slug' => $student_course->courses->slug ]) }}"><button type="button" class="btn btn-warning btn-sm">Read more and buy</button></a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @elseif(count($student_courses_type1) == 2)
                            @php
                            $loopCount = 0;
                            @endphp
                            <div class="row col-lg-12 col-sm-12">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="card {{$loopCount == 0 ? "bg-primary" : "bg-warning" }}" style="width: 100%; height: 100%;">
                                    <div class="card-body">
                                        <h5 class="card-title text-center text-white p-2">
                                            <span class="border border-dark p-2">{{ str_limit($student_course->courses->title, $limit = 30, $end = '...') }}</span>
                                        </h5>
                                        ...
                                        <p class="card-text">{{$student_course->courses->short_detail}}</p>
                                        <p class="card-text text-center pt-2">
                                            <a href="{{route('course.content',['id' => $student_course->courses->id, 'slug' => $student_course->courses->slug ]) }}">
                                                <button type="button" class="btn btn-sm {{$loopCount == 0 ? 'btn-warning' : 'btn-danger'}}">Read more and buy</button>
                                            </a>
                                        </p>
                                    </div>
                                </div>
                        ...
                        @elseif(count($student_courses_type1) == 3)
                        @php
                        $loopCount = 0;
                        @endphp
                        <div class="row col-lg-12 col-sm-12">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                <div class="card {{$loopCount == 0 ? "bg-primary" : ($loopCount == 1 ? "bg-warning" : "bg-success") }}" style="width: 100%; height: 100%;">
                                <div class="card-body">
                                    <h5 class="card-title text-center text-white p-2">
                                        <span class="border border-dark p-2">{{ str_limit($student_course->courses->title, $limit = 30, $end = '...') }}</span>
                                    </h5>
        ...
        <h2>
            ...
            <span class="step-text">Class 6 to 8</span>
        </h2>
        <section>
            <div class="inner">
                <div class="form-heading">
        ...
        <h2>
            ...
            <span class="step-text">Class 9 to 10</span>
        </h2>
        <section>
            <div class="inner">
                <div class="form-heading">
...
<script src="{{url('wizard/js/jquery-ui.min.js')}}"></script>
