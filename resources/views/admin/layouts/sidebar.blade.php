...
<!--                    <li class="{{ Nav::isResource('childcategory') }}"><a href="{{url('childcategory')}}"><i class="flaticon-rec"></i>{{ __('adminstaticword.ChildCategory') }}</a></li>-->
                ...
                <li class="{{ Nav::isResource('batch-setting') }}"><a href="{{url('batch-setting')}}"><i class="flaticon-document" aria-hidden="true"></i><span>{{ __('adminstaticword.BatchSettings') }}</span></a></li>
